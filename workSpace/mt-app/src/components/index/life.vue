    ...
    <div class="m-life">
        <el-row>
            <ul class="nav">
                ...
                <li>
                    <router-link to="/" >美团供应</router-link>
                </li>
            </ul>
        </el-row>
        <el-row>
            ...
            <el-col :span="6">
                <div class="m-life-login">
                    ...
                    <p v-if="!$store.state.userName">
                        <router-link :to="{name: 'register'}"><el-button round>登录</el-button></router-link>
                    </p>
                    <p v-if="!$store.state.userName">
                        <router-link :to="{name: 'login'}"><el-button round>立即注册</el-button></router-link>
                    </p>
                </div>
            </el-col>
        </el-row>
